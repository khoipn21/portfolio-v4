...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      "Dynamic, responsive interface with seamless navigation and efficient product management.",
      "Search, product filtering, and user authentication for a secure shopping experience.",
      "Full cart and checkout workflow with order management.",
    ],
  },
  {
    slug: "bookstore",
...
export const skills: Skill[] = [
  ...
  { name: "Mantine", icon: "mantine", category: "frontend" },
  { name: "TanStack Query", icon: "reactquery", category: "frontend" },
  { name: "Zustand", icon: "zustand", category: "frontend" },
  { name: "GSAP", icon: "greensock", category: "frontend" },
