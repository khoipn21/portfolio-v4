      ...
      <div className="flex w-full flex-wrap gap-2">
        {skills.map((skill, index) => {
          ...
          return (
            <div
              key={index}
              className="flex grow cursor-default items-center justify-center gap-2 rounded-full px-3.5 py-2 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:scale-[1.05]"
              style={{
