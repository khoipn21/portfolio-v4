...
export function ProfileHeader() {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute top-[22vh] right-0 left-0 z-50 flex items-start px-4 pt-6 md:right-[15%] md:left-[15%] lg:right-[30%] lg:left-[30%]"
    >
      <div className="flex w-full items-start justify-between">
        ...
        <div className="flex flex-col items-start gap-2 lg:flex-row lg:items-center lg:gap-5">
          ...
          <div
            className="relative shrink-0 rounded-[12px] border-[1.5px] p-[3px] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] sm:rounded-[14px]"
            style={{ borderColor: 'var(--border-primary)' }}
          >
            <div
              className="relative h-16 w-16 overflow-hidden rounded-[9px] sm:h-20 sm:w-20 sm:rounded-[11px]"
              style={{
          ...
          <div className="flex flex-col items-start">
            <h1
              ref={nameRef}
              className="mb-0.5 overflow-hidden text-[20px] leading-none font-bold tracking-tight whitespace-nowrap sm:text-[24px]"
              style={{
            ...
            <p
              className="max-w-none text-[13px] sm:text-[14px]"
